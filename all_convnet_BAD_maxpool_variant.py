...
#temporal squeeing
model.add(MaxPooling1D((500), strides=(500)))
model.add(Dropout(0.50))
...
#save_model
model.save('all_convnet_maxpool_variant.h5') 
...
np.savetxt('allconvnet_maxpool_variant',np.c_[class_file,pred_probs[:,0],pred_probs[:,1]],fmt='%s')
